class TimeZone2CountryConverter {
    ...
    static timeZone2Country(timeZone) {
        return TimeZone2CountryConverter.#countryByCity[TimeZone2CountryConverter.#getCity(timeZone)];
    }

    static #getCity(timeZone) {
        return timeZone.split("/").at(-1);
    }

    // copied from https://www.techighness.com/post/json-dictionary-for-mapping-timezone-cities-to-countries/
    static #countryByCity =
        {
            "Andorra": "Andorra",
